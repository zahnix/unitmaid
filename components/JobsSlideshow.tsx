...
export default function JobsSlideshow() {
  ...
  const cards = [
    ...
    {
      title: 'Relocation from Cube Smart to Super Storage',
      text:
        "Convenient and fast relocation for regional customers",
      image:
        'https://images.unsplash.com/photo-1607227063002-677dc5fdf96f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1548&q=80',
    },
  ];
          ...
          <Box
            ...
            <Container size="container.lg" height="600px" position="relative">
              <Stack
                ...
                top="50%"
                transform="translate(0, -50%)">
                <Heading fontSize={{ base: '4xl', md: '5xl', lg: '6xl' }} color={'white'}>
                  {card.title}
                </Heading>
